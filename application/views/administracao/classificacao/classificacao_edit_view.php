                  ...
                  <div class="widget-content-white glossed">
                    <div class="padded">
						<?php 			
							...
							echo '<h3 class="form-title form-title-first"><i class="icon-terminal"></i> Cadastrar / Editar Classificação</h3>';
							...
							echo '&nbsp;<a href="'.$base.'administracao/classificacoes/" class="btn btn-danger">Cancelar</a>';
						?>
                 	</div>
                  </div>
                </div>
